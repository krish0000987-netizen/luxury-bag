  ...
  return `
    ...
    <header class="site-header" id="site-header">
      <div class="luxury-container header-inner">
        <!-- Mobile Hamburger -->
        <button class="mobile-menu-trigger" id="mobile-menu-open" aria-label="Open Menu">
        ...
        <div class="header-actions">
          <button class="header-icon-btn" id="header-search-btn" title="Search Handbags">
            <svg viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
          </button>

          <button class="header-icon-btn" id="header-wishlist-btn" title="Wishlist">
            <svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
            ${wishlistCount > 0 ? `<span class="badge-counter" id="wishlist-badge">${wishlistCount}</span>` : `<span class="badge-counter" id="wishlist-badge" style="display:none">0</span>`}
          </button>

          <button class="header-icon-btn" id="header-cart-btn" title="Shopping Bag">
    ...
    <div class="mobile-nav-drawer" id="mobile-nav-drawer">
      <div style="display:flex; justify-content:space-between; align-items:center;">
        <div>
          <span style="font-family:var(--font-display); font-size:1.4rem; color:var(--color-ivory); letter-spacing:0.2em; font-weight:700;">LUXURY BAGS</span>
        ...
        <button id="mobile-menu-close" style="color:var(--color-ivory); font-size:1.8rem; background:none; border:none; cursor:pointer;">&times;</button>
      </div>

      <ul class="mobile-nav-links">
        <li><a href="#/" class="mobile-nav-link">Home</a></li>
        <li><a href="#/shop" class="mobile-nav-link">Shop All</a></li>
        <li><a href="#/new-arrivals" class="mobile-nav-link">New Arrivals</a></li>
        <li><a href="#/bridal" class="mobile-nav-link">Bridal Collection</a></li>
        <li><a href="#/clutches" class="mobile-nav-link">Clutch Collection</a></li>
        <li><a href="#/handbags" class="mobile-nav-link">Luxury Handbags</a></li>
        <li><a href="#/about" class="mobile-nav-link">About Us</a></li>
        <li><a href="#/craftsmanship" class="mobile-nav-link">Jaipur Craftsmanship</a></li>
        <li><a href="#/lookbook" class="mobile-nav-link">Lookbook</a></li>
        <li><a href="#/contact" class="mobile-nav-link">Contact & Store</a></li>
      </ul>

      <div style="margin-top:auto; padding-top:2rem; border-top:1px solid rgba(197,160,89,0.25);">
        <div style="font-size:0.8rem; color:var(--color-gold-light); margin-bottom:0.75rem;">Direct Jaipur Store Line:</div>
        <a href="tel:${STORE_DETAILS.phone}" style="display:block; font-size:1.1rem; color:var(--color-ivory); font-weight:600; margin-bottom:1rem;">${STORE_DETAILS.phone}</a>
        <a href="${buildWhatsAppLink("Hello, I would like to inquire about LUXURY BAGS.")}" target="_blank" class="btn-whatsapp" style="width:100%;">Order on WhatsApp</a>
      </div>
    </div>
  `;
}
